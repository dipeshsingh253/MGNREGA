...
import com.mgnrega.dao.GramPanchayatMemberImpl;

public class GramPanchayatMember extends GramPanchayatMemberImpl {
	...
	public GramPanchayatMember(int id, String name, String email, String username, String password, int proj_id) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
